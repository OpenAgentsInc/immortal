...
| Adversarial-lab #18 closed-world execution: exact isolated two-provider/two-relay topology, 43 routing/failure/doomsday/cooperative cases including ten Liquid cases, independent evidence views, cleanup laws, and explicit deployment/replacement exclusions; all 43 plus bounded aggregate generation passed from pushed `main` `6c4cd10` | `tests/fixtures/lab/adversarial-v1.json`, `scripts/test-lab-adversarial.sh --all`, and [`records/2026-08-06-adversarial-regtest-6c4cd10.json`](records/2026-08-06-adversarial-regtest-6c4cd10.json) |
