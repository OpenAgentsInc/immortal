...
use crate::{
    domain::{
        ...
        MKT_LSP_SERVICE_CONTRACT_KIND, MKT_LSP_SIDES, MKT_LSP_SOURCE_PROTOCOLS,
        ...
        MKT_MINT_OPERATIONS_FEDIMINT, MKT_MINT_PROFILE_ID, MKT_MINT_PROFILE_VERSION,
        MKT_MINT_RAILS, MKT_MINT_ROUTE_CONTRACT_KIND, MKT_MINT_STATUS_EXTENSIONS,
        MKT_OFFERING_KIND, MKT_OFFERING_STATUSES, MKT_ORDER_KIND, MKT_OUTCOMES,
        MKT_P2P_AMOUNT_MODES, MKT_P2P_CUSTODY_CLASS, MKT_P2P_EVIDENCE_PROVENANCE,
        MKT_P2P_PROFILE_ID, MKT_P2P_PROFILE_VERSION, MKT_P2P_RECIPIENT_ROLES,
        MKT_P2P_RESOLUTION_DECISIONS, MKT_P2P_RESOLUTION_KIND, MKT_P2P_RESOLUTION_ROLES,
        MKT_P2P_RESOLUTION_SCOPES, MKT_P2P_STATUS_BASE_STATES, MKT_P2P_STATUS_EXTENSION_STATES,
...
pub struct MktGrammar {
    ...
    pub mkt_p2p: MktP2pGrammar,
    pub mkt_lsp: MktLspGrammar,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct MktP2pGrammar {
    pub id: &'static str,
    pub version: u64,
    pub resolution_kind: u16,
    pub scope: &'static str,
    pub resolution_publication: &'static str,
    pub resolution_alt: &'static str,
    pub resolution_roles: Vec<&'static str>,
    pub recipient_roles: Vec<&'static str>,
    pub resolution_decisions: Vec<&'static str>,
    pub resolution_scopes: Vec<&'static str>,
    pub evidence_provenance: Vec<&'static str>,
    pub registry_asset_id_rule: &'static str,
    pub canonical_amount_pattern: &'static str,
    pub offering_required_members: Vec<&'static str>,
    pub amount_modes: Vec<&'static str>,
    pub custody_class: &'static str,
    pub nip69_bridge: &'static str,
    pub source_reference_members: Vec<&'static str>,
    pub admitted_status_states: Vec<&'static str>,
    pub public_privacy: &'static str,
    pub external_authority: &'static str,
    pub upstream_fixture_cases: usize,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct MktLspGrammar {
    pub id: &'static str,
    pub version: u64,
    pub service_contract_kind: u16,
    pub scope: &'static str,
    pub contract_publication: &'static str,
    pub contract_alt: &'static str,
    pub contract_roles: Vec<&'static str>,
    pub contract_members: Vec<&'static str>,
    pub contract_digest_members: Vec<&'static str>,
    pub registry_asset_id_rule: &'static str,
    pub canonical_amount_pattern: &'static str,
    pub offering_required_members: Vec<&'static str>,
    pub sides: Vec<&'static str>,
    pub payment_methods: Vec<&'static str>,
    pub zero_conf_policies: Vec<&'static str>,
    pub custody_class: &'static str,
    pub reservation_proof_classes: Vec<&'static str>,
    pub hard_reservation_proof_classes: Vec<&'static str>,
    pub lsps_bridge: &'static str,
    pub source_reference_members: Vec<&'static str>,
    pub source_protocols: Vec<&'static str>,
    pub admitted_status_states: Vec<&'static str>,
    pub public_privacy: &'static str,
    pub external_authority: &'static str,
    pub upstream_fixture_cases: usize,
...
fn mkt_grammar() -> MktGrammar {
    ...
    required_tags.insert(
        ...
        vec![
            ...
            "profile=mkt-p2p:1",
            "order e",
            "previous e when appeal",
            "maker p",
            "taker p",
            "coordinator p",
            "author solver/appeal-arbiter p",
            "role",
            "alt=MKT-P2P resolution",
        ],
    );
    required_tags.insert(
        "mkt_lsp_service_contract",
        vec![
            ...
            "order e",
            "status e when accepted_status_event_id is not null",
            "complementary counterparty p",
            "role",
            "x=contract_sha256",
            "alt=MKT-LSP service contract",
        ],
    );
    ...
    MktGrammar {
        ...
        mkt_p2p: MktP2pGrammar {
            id: MKT_P2P_PROFILE_ID,
            version: MKT_P2P_PROFILE_VERSION,
            resolution_kind: MKT_P2P_RESOLUTION_KIND,
            scope: "relay_observable_only",
            resolution_publication: "private_signed_record_nip59_only",
            resolution_alt: "MKT-P2P resolution",
            resolution_roles: MKT_P2P_RESOLUTION_ROLES.to_vec(),
            recipient_roles: MKT_P2P_RECIPIENT_ROLES.to_vec(),
            resolution_decisions: MKT_P2P_RESOLUTION_DECISIONS.to_vec(),
            resolution_scopes: MKT_P2P_RESOLUTION_SCOPES.to_vec(),
            evidence_provenance: MKT_P2P_EVIDENCE_PROVENANCE.to_vec(),
            registry_asset_id_rule: "namespace:reference registry identifiers only; bare tickers rejected",
            canonical_amount_pattern: "^(0|[1-9][0-9]*)$",
            offering_required_members: vec![
                "market",
                "sides",
            ...
            amount_modes: MKT_P2P_AMOUNT_MODES.to_vec(),
            custody_class: MKT_P2P_CUSTODY_CLASS,
            nip69_bridge: "source_reference_mapping_only; nip69_and_mostro_events_stay_canonical; no_signature_upgrade",
            source_reference_members: vec![
                "protocol",
                "revision",
                "event_id",
                "source_sha256",
            ...
            admitted_status_states: MKT_P2P_STATUS_BASE_STATES
                .iter()
                .chain(MKT_P2P_STATUS_EXTENSION_STATES)
                .copied()
                .collect(),
            public_privacy: "no_pii_account_invoice_credential_trade_key_linkage_or_dispute_evidence_in_public_records",
            external_authority: "escrow_hold_invoice_bond_dispute_payment_and_settlement_verification_not_claimed; no_independent_exit_evaluation_is_client_scope",
            upstream_fixture_cases: 26,
        },
        mkt_lsp: MktLspGrammar {
            id: MKT_LSP_PROFILE_ID,
            version: MKT_LSP_PROFILE_VERSION,
            service_contract_kind: MKT_LSP_SERVICE_CONTRACT_KIND,
            scope: "relay_observable_only",
            contract_publication: "private_signed_record_nip59_only",
            contract_alt: MKT_LSP_SERVICE_CONTRACT_ALT,
            contract_roles: vec!["requester", "provider"],
            contract_members: vec![
                "quote_event_id",
                "order_event_id",
                "accepted_status_event_id",
            ...
            registry_asset_id_rule: "namespace:reference registry identifiers only; bare BTC/sat/mainnet labels rejected",
            canonical_amount_pattern: "^(0|[1-9][0-9]*)$",
            offering_required_members: vec![
                "lsp_node_id",
                "network_id",
            ...
            sides: MKT_LSP_SIDES.to_vec(),
            payment_methods: MKT_LSP_PAYMENT_METHODS.to_vec(),
            zero_conf_policies: MKT_LSP_ZERO_CONF_POLICIES.to_vec(),
            custody_class: MKT_LSP_CUSTODY_CLASS,
            reservation_proof_classes: MKT_LSP_RESERVATION_PROOF_CLASSES.to_vec(),
            hard_reservation_proof_classes: MKT_LSP_HARD_RESERVATION_PROOF_CLASSES.to_vec(),
            lsps_bridge: "source_reference_mapping_only; lsps_json_rpc_over_bolt8_stays_canonical; no_signature_upgrade",
            source_reference_members: vec![
                "protocol",
                "revision",
                "method",
            ...
            source_protocols: MKT_LSP_SOURCE_PROTOCOLS.to_vec(),
            admitted_status_states: MKT_LSP_STATUS_BASE_STATES
                .iter()
                .chain(MKT_LSP_STATUS_EXTENSION_STATES)
                .copied()
                .collect(),
            public_privacy: "no_invoice_payment_hash_scid_channel_id_address_coupon_token_or_transaction_plan_in_public_records; no_custody_material_anywhere",
            external_authority: "channel_open_jit_execution_lsp_node_operation_fee_settlement_reservation_proof_and_price_feed_verification_not_claimed; independent_exit_evaluation_is_client_scope",
            upstream_fixture_cases: 30,
        },
        required_tags,
        enums,
        identifiers,
