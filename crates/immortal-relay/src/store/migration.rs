...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 9,
        name: "mkt_gateway_privacy",
        sql: include_str!("../../../../migrations/0009_mkt_gateway_privacy.sql"),
    },
    Migration {
        version: 10,
        name: "mkt_swp_profile",
        sql: include_str!("../../../../migrations/0010_mkt_swp_profile.sql"),
    },
    Migration {
        version: 11,
        name: "mkt_swp_coordination",
        sql: include_str!("../../../../migrations/0011_mkt_swp_coordination.sql"),
    },
    Migration {
        version: 12,
        name: "mkt_p2p_profile",
        sql: include_str!("../../../../migrations/0012_mkt_p2p_profile.sql"),
    },
    Migration {
        version: 13,
    ...
    Migration {
        version: 15,
        name: "mkt_swp_hardening",
        sql: include_str!("../../../../migrations/0015_mkt_swp_hardening.sql"),
    },
    Migration {
        version: 16,
        name: "mkt_swp_receipt",
        sql: include_str!("../../../../migrations/0016_mkt_swp_receipt.sql"),
    },
];
