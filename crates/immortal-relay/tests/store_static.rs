...
#[test]
fn mkt_swp_hardening_migration_keeps_revision_two_private_and_immutable() {
    let sql = include_str!("../../../migrations/0015_mkt_swp_hardening.sql");
    for required in [
        "kind BETWEEN 39604 AND 39612",
